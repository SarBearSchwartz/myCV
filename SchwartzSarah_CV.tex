...
\item Thurston, T. N., Lundstrom, K., GonzÃ¡lez, C., Stommel, J., Masland, L. C., Buyserie, B., ... \& Eason, A. (2021). Resilient Pedagogy: Practical Teaching Strategies to Overcome Distance, Disruption, and Distraction.%
...
\begin{center}\includegraphics{SchwartzSarah_CV_files/figure-latex/unnamed-chunk-2-1} \end{center}
...
\leavevmode\vadjust pre{\hypertarget{ref-Benallie2021life}{}}%
\CSLLeftMargin{3. }
...
\leavevmode\vadjust pre{\hypertarget{ref-mcclain2021noise}{}}%
\CSLLeftMargin{4. }
...
\leavevmode\vadjust pre{\hypertarget{ref-Reuveni2021cannabinoids}{}}%
\CSLLeftMargin{5. }
...
\leavevmode\vadjust pre{\hypertarget{ref-golson2021current}{}}%
\CSLLeftMargin{7. }
...
\leavevmode\vadjust pre{\hypertarget{ref-Wengreen2021fit}{}}%
\CSLLeftMargin{3. }
...
\end{itemize}}
    \cventry{(in progress)}{Carly Fox}{Communicative Disorders and Deaf Education}{Utah State University}{}{\begin{itemize}%
...
\item Executivve Functioning in Children With ASD and Co-Occurring Neurodevelopmental Disorders: A Systematic Review and Quantitative Analysis%
...
\end{itemize}}
    \cventry{(in progress)}{Rylan Helstern}{Human Development \& Family Studies}{Utah State University}{}{\begin{itemize}%
...
\item Mentor: Dr. Sandra Gillam%
\end{itemize}}
    \cventry{Aug 2019}{Eliza Jex}{Special Education and Rehabilitation}{}{}{\begin{itemize}%
